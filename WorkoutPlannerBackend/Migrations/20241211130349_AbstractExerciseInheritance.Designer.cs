...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkoutPlannerBackend.Entities.Models.AbstractExercise", b =>
                {
            ...
            modelBuilder.Entity("WorkoutPlannerBackend.Entities.Models.CustomExercise", b =>
                {
                    b.HasBaseType("WorkoutPlannerBackend.Entities.Models.AbstractExercise");
            ...
            modelBuilder.Entity("WorkoutPlannerBackend.Entities.Models.ExerciseWorkout", b =>
                {
                    b.HasOne("WorkoutPlannerBackend.Entities.Models.AbstractExercise", "Exercise")
                        .WithMany()
            ...
            modelBuilder.Entity("WorkoutPlannerBackend.Entities.Models.CustomExercise", b =>
                {
                    ...
                    b.HasOne("WorkoutPlannerBackend.Entities.Models.AbstractExercise", null)
                        .WithOne()
                        .HasForeignKey("WorkoutPlannerBackend.Entities.Models.CustomExercise", "ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("WorkoutPlannerBackend.Entities.Models.Exercise", b =>
                {
                    b.HasOne("WorkoutPlannerBackend.Entities.Models.AbstractExercise", null)
                        .WithOne()
                        .HasForeignKey("WorkoutPlannerBackend.Entities.Models.Exercise", "ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
